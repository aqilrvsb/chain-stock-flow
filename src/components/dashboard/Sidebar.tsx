import { Home, Package, Users, BarChart3, Settings, LogOut, Gift, DollarSign, Award, FileText, UserCheck, BookOpen, ChevronDown, Warehouse, ArrowRightFromLine } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
