...
import { CheckCircle, XCircle, AlertTriangle, Loader, PackageCheck } from "lucide-react";
import { format } from "date-fns";

const ProcessedStockView = () => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            View processed product inventory with packaging status (read-only)
          </p>
        </div>
      </div>
...
export default ProcessedStockView;
