-- ============================================================
-- INSERT DATA FROM LOVABLE CLOUD - WITH NEW UUIDs
-- Chain Stock Flow - Data Migration
-- ============================================================
--
-- This script inserts all data with YOUR NEW Supabase UUIDs
-- Run this AFTER running COMPLETE_DATABASE_SETUP_WITH_ALL_POLICIES.sql
--
-- UUID Mapping:
-- OLD (Lovable Cloud) → NEW (Your Supabase)
-- 455f37a3-9596-4812-bc26-be12345b9ffd (HQ) → 53bbc555-6d42-4c94-862b-5a448b77aeec
-- 3fe50999-ecc2-4ba9-b1f2-c6b4b1fb3923 (MA) → 6cd9af45-2483-421f-a224-d881c2aabf65
-- 657c9f0b-6f3f-4ff0-874f-e7fd50810528 (Agent) → 2f4b81f0-dddb-430e-b262-41e2aef22f10
--
-- ============================================================
...
-- ============================================================
-- STEP 2: INSERT/UPDATE PROFILES (users already exist from auth.users)
-- ============================================================

-- Insert or update profiles (in case trigger didn't create them)
...
VALUES
  ('53bbc555-6d42-4c94-862b-5a448b77aeec', 'hq@gmail.com', '', NULL, true, 'OJHQ', NULL, NULL, NULL, NOW(), '2025-11-03 13:36:52.092251+00'),
  ('6cd9af45-2483-421f-a224-d881c2aabf65', 'aqil@gmail.com', 'MA-aqil', '', true, 'MA-001', '60108924904', '60108924904', 'Lot 34 Taman SEDC Kampung Raja 22200 Besut Terengganu', NOW(), '2025-11-02 13:43:28.067973+00'),
  ('2f4b81f0-dddb-430e-b262-41e2aef22f10', 'em@gmail.com', 'em', '', true, NULL, NULL, NULL, NULL, NOW(), '2025-11-02 07:14:05.515702+00')
ON CONFLICT (id) DO UPDATE SET
...
VALUES
  ...
  (gen_random_uuid(), '6cd9af45-2483-421f-a224-d881c2aabf65', 'master_agent', '53bbc555-6d42-4c94-862b-5a448b77aeec', NOW()),
  (gen_random_uuid(), '2f4b81f0-dddb-430e-b262-41e2aef22f10', 'agent', '53bbc555-6d42-4c94-862b-5a448b77aeec', NOW())
...
VALUES
  (gen_random_uuid(), '6cd9af45-2483-421f-a224-d881c2aabf65', '2f4b81f0-dddb-430e-b262-41e2aef22f10', NOW())
...
VALUES
  ...
  (gen_random_uuid(), '6cd9af45-2483-421f-a224-d881c2aabf65', '8b08ef3c-ab8b-4fcd-95f4-f1058a073acc', 324, '2025-11-02 12:55:11.474573+00')
...
VALUES
  (gen_random_uuid(), '6cd9af45-2483-421f-a224-d881c2aabf65', NULL, '8b08ef3c-ab8b-4fcd-95f4-f1058a073acc', 324, 60.00, 19440.00, 'purchase', '2025-11-02 12:55:10.838874+00')
...
-- Add billplz_bill_id column if it doesn't exist
...
VALUES
  (gen_random_uuid(), '1000', '6cd9af45-2483-421f-a224-d881c2aabf65', '8b08ef3c-ab8b-4fcd-95f4-f1058a073acc', 12, 60, 720, 'pending', '2025-11-02 16:15:51.573946+00', '2025-11-02 16:15:51.573946+00', NULL, NULL),
  (gen_random_uuid(), 'ON1', '6cd9af45-2483-421f-a224-d881c2aabf65', '8b08ef3c-ab8b-4fcd-95f4-f1058a073acc', 12, 60, 720, 'pending', '2025-11-03 14:46:09.329877+00', '2025-11-03 14:46:09.329877+00', 'c5221ab5fdaf7e43', NULL),
  (gen_random_uuid(), 'ON2', '6cd9af45-2483-421f-a224-d881c2aabf65', '8b08ef3c-ab8b-4fcd-95f4-f1058a073acc', 12, 60, 720, 'pending', '2025-11-03 14:46:46.915572+00', '2025-11-03 14:46:46.915572+00', '55b3779b3f3d952d', NULL),
  (gen_random_uuid(), 'ON3', '6cd9af45-2483-421f-a224-d881c2aabf65', '8b08ef3c-ab8b-4fcd-95f4-f1058a073acc', 12, 60, 720, 'failed', '2025-11-03 14:47:14.228142+00', '2025-11-03 14:47:41.625564+00', '512e50033ce097ed', NULL),
  (gen_random_uuid(), 'ON4', '6cd9af45-2483-421f-a224-d881c2aabf65', '8b08ef3c-ab8b-4fcd-95f4-f1058a073acc', 12, 60, 720, 'failed', '2025-11-03 15:01:46.129551+00', '2025-11-03 15:02:06.777454+00', '251320f705aa4022', '251320f705aa4022')
...
-- ✓ 1 Product (Olive Oil)
-- ✓ 3 Profiles Updated (HQ, Master Agent, Agent)
-- ✓ 3 User Roles
...
-- ✓ 1 System Setting
--
-- Your users with NEW UUIDs:
-- HQ: 53bbc555-6d42-4c94-862b-5a448b77aeec (hq@gmail.com)
-- Master Agent: 6cd9af45-2483-421f-a224-d881c2aabf65 (aqil@gmail.com)
-- Agent: 2f4b81f0-dddb-430e-b262-41e2aef22f10 (em@gmail.com)
--
-- ============================================================
