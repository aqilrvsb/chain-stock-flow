...
CREATE INDEX idx_stock_in_hq_date ON public.stock_in_hq(date);
CREATE INDEX idx_stock_in_hq_product ON public.stock_in_hq(product_id);
CREATE INDEX idx_stock_in_hq_user ON public.stock_in_hq(user_id);