...
const RewardAgentPlatinum = () => {
  ...
  const { data: rewardData, isLoading } = useQuery({
    queryKey: ["reward-agent-platinum-progress", periodFilter, selectedMonth, selectedYear],
    queryFn: async () => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Track Platinum Agent performance towards reward targets
        </p>
      </div>
            ...
            <div className="space-y-2">
              ...
              <RadioGroup value={periodFilter} onValueChange={(value: any) => setPeriodFilter(value)} className="flex gap-4">
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="monthly" id="agent-platinum-filter-monthly" />
                  <Label htmlFor="agent-platinum-filter-monthly" className="font-normal cursor-pointer">Monthly</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="yearly" id="agent-platinum-filter-yearly" />
                  <Label htmlFor="agent-platinum-filter-yearly" className="font-normal cursor-pointer">Yearly</Label>
                </div>
              </RadioGroup>
            </div>
